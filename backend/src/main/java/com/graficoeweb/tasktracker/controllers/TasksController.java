...
public class TasksController {
	...
	@PostMapping
	public ResponseEntity<TasksDTO> insert(@RequestBody TasksDTO dto) {
	...
	@PutMapping("/{id}")
	public ResponseEntity<TasksDTO> update(@PathVariable Long id, @RequestBody TasksDTO dto) {
		TasksDTO obj = service.update(id, dto);
